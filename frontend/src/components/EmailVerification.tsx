...
function EmailVerification({ email, onVerificationComplete, onResendCode }: EmailVerificationProps) {
  ...
  const handleVerify = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch("https://poosdboard.com/api/verify-email", {
        method: "POST",
  ...
  const handleResend = async () => {
    ...
    try {
      const response = await fetch("https://poosdboard.com/api/send-verification", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
  ...
  return (
    <div style={layoutStyle}>
      <div style={cardStyle}>
        ...
        <span style={linkStyle} onClick={handleResend}>
